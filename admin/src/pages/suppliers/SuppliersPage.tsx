...
export function SuppliersPage() {
  ...
  const updateMutation = useMutation({
    ...
    onError: (error) =>
      toast.error(getErrorMessage(error, "حدث خطأ أثناء تحديث المورد")),
  });
  ...
  const paymentMutation = useMutation({
    ...
    onError: (error) =>
      toast.error(getErrorMessage(error, "حدث خطأ أثناء تسجيل الدفعة")),
  });
            ...
            <div className="border-t pt-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    {...createForm.register("paymentTerms")}
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          ...
          <p className="text-muted-foreground">
            هل أنت متأكد من حذف المورد "{selectedSupplier?.name}"؟ هذا الإجراء
            لا يمكن التراجع عنه.
          </p>
          <DialogFooter>
            <Button
