...
export function RolesPage() {
  ...
  const createMutation = useMutation({
    ...
    onError: (error) =>
      toast.error(getErrorMessage(error, "حدث خطأ أثناء إنشاء الدور")),
  });
  ...
  const updateMutation = useMutation({
    ...
    onError: (error) =>
      toast.error(getErrorMessage(error, "حدث خطأ أثناء تحديث الدور")),
  });
  ...
  const deleteMutation = useMutation({
    ...
    onError: (error) =>
      toast.error(getErrorMessage(error, "حدث خطأ أثناء حذف الدور")),
  });
  ...
  const setPermissionsMutation = useMutation({
    ...
    onError: (error) =>
      toast.error(getErrorMessage(error, "حدث خطأ أثناء تحديث الصلاحيات")),
  });
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          ...
          <p className="text-muted-foreground">
            هل أنت متأكد من حذف الدور "{selectedRole?.name}"؟ هذا الإجراء لا
            يمكن التراجع عنه.
          </p>
          <DialogFooter>
            <Button
