...
export class ContentController {
    ...
    async getTestimonials(@Query('limit') limit?: number) {
        const testimonials = await this.contentService.findActiveTestimonials(limit);
    ...
    async approveTestimonial(@CurrentUser() user: any, @Param('id') id: string) {
        const testimonial = await this.contentService.approveTestimonial(id, user.adminId);
