...
export class AuditController {
    ...
    async getLoginHistory(
        ...
        const history = await this.auditService.getLoginHistory(userId, userType, limit);
    ...
    async getMyLoginHistory(@CurrentUser() user: any, @Query('limit') limit?: number) {
        const history = await this.auditService.getLoginHistory(user.adminId, 'admin', limit);
        return ResponseBuilder.success(history);
    }
