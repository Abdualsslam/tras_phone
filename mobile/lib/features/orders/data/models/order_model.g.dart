...
OrderModel _$OrderModelFromJson(Map<String, dynamic> json) => OrderModel(
  ...
  walletBalanceBefore: (json['walletBalanceBefore'] as num?)?.toDouble() ?? 0.0,
  walletAmountUsed: (json['walletAmountUsed'] as num?)?.toDouble() ?? 0.0,
  walletBalanceAfter: (json['walletBalanceAfter'] as num?)?.toDouble() ?? 0.0,
  remainingAfterWallet: (json['remainingAfterWallet'] as num?)?.toDouble() ?? 0.0,
...
Map<String, dynamic> _$OrderModelToJson(
  ...
  'walletBalanceBefore': instance.walletBalanceBefore,
  'walletAmountUsed': instance.walletAmountUsed,
  'walletBalanceAfter': instance.walletBalanceAfter,
  'remainingAfterWallet': instance.remainingAfterWallet,
